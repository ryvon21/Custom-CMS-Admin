...
if( isset( $_GET['id'] ) )
{
  ...
  if( isset( $_GET['delete'] ) )
  {
    ...
    set_message( 'Photo has been deleted' );
...
<?php if( $record['photo'] ): ?>
  ...
  <p><a href="reviews_photo.php?id=<?php echo $_GET['id']; ?>&delete"><i class="fas fa-trash-alt"></i> Delete this Photo</a></p>
...
<p><a href="posts.php"><i class="fas fa-arrow-circle-left"></i> Return to Posts</a></p>
